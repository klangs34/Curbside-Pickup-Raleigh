      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-6 mr-auto">
            <ul
              className="text-align-left px-0"
          ...
          <div className="col-sm-6 text-white">
            ...
            >
              <li className="pl-2 mr-2 mb-2" style={{ fontSize: "16px" }}>
                <a
                  className="text-white"
                  href="https://github.com/wdvaughn/"
                  title=" William Vaughn on Github"
                >
              ...
              <li className="pl-2 mr-2 mb-2 " style={{ fontSize: "16px" }}>
                <a
                  className="text-white"
                  href="https://github.com/bclark07"
                  title="Brittany Clark on Github"
                >
                  <img src="https://img.icons8.com/material-rounded/24/000000/github.png" />
                  Brittany Clark
                </a>
              ...
              <li className="pl-2 mr-2 mb-2" style={{ fontSize: "16px" }}>
                <a
                  ...
                  title="Kelsie Langston on Github"
                >
                  <img src="https://img.icons8.com/material-rounded/24/000000/github.png" />
                  Kelsie Langston{" "}
                </a>
